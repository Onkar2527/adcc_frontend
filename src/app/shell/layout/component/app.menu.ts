...
export class AppMenu implements OnInit, OnDestroy {
      ...
      items: [
        {
          ...
          routerLink: ['/auditor/audit-dashboard'],
        },
        {
          label: 'Audit Calendar',
          icon: 'pi pi-fw pi-calendar',
    ...
    },
    {
      ...
      items: [
          ...
          items: [
            {
              ...
              icon: 'pi pi-fw pi-users',
              routerLink: ['/admin/employee-master'],
            },
            {
        ...
        },
        {
          ...
          routerLink: ['/admin/audit-section-master'],
        },
        {
          label: 'Unit Master',
          icon: 'pi pi-fw pi-building',
          routerLink: ['/admin/audit-unit-master'],
        },
        ...
        {
          label: 'Multiple Auditor Assignment',
          icon: 'pi pi-fw pi-users',
          routerLink: ['/admin/multiple-auditor-assignment'],
        },
        {
          label: 'Manage Assessment Master',
          icon: 'pi pi-fw pi-chart-bar',
          routerLink: ['/admin/manage-assessment-master'],
        },
        { label: 'Special Audit', icon: 'pi pi-fw pi-flag', routerLink: ['/admin/special-audit'] },
        {
          label: 'Annexure Master',
          icon: 'pi pi-fw pi-file-edit',
          routerLink: ['/admin/audit-annexure-master'],
        },
        {
          label: 'Risk Master',
          ...
          items: [
            {
              ...
              icon: 'pi pi-fw pi-tags',
              routerLink: ['/admin/risk-categories'],
            },

            {
              label: 'Risk Controls',
              icon: 'pi pi-fw pi-sliders-h',
              routerLink: ['/admin/risk-controls'],
            },

            {
              label: 'Composite Risk',
              icon: 'pi pi-fw pi-share-alt',
              routerLink: ['/admin/risk-composites'],
            },

            {
              label: 'Risk Matrix',
              icon: 'pi pi-fw pi-table',
              routerLink: ['/admin/risk-matrix'],
            },

            {
              label: 'Branch Rating',
              icon: 'pi pi-fw pi-chart-line',
              routerLink: ['/admin/branch-rating'],
            },
          ],
        },
      ],
  ...
  private refreshModel() {
    ...
    if (
      shouldShowAssessmentMenu &&
      currentAssessmentId === Number(this.auditNavService.assessmentId())
    ) {
      filtered.push(this.buildAssessmentMenu(currentAssessmentId));
    }

    if (assessmentMenuKey === this.lastAssessmentMenuKey && this.model.length) {
      return;
    }

    this.lastAssessmentMenuKey = assessmentMenuKey;
  ...
  private currentAssessmentIdFromRoute() {
    ...
    let match = url.match(/\/auditor\/internal-audit\/(\d+)(?:\?|$)/);
  ...
  private shouldShowCurrentAssessmentMenu(currentAssessmentId: number) {
    ...
    return !(
      url.includes('/auditor/internal-audit/executive-summary/') && url.includes('mode=reviewer')
    );
  }
