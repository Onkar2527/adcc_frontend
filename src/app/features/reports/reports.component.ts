...
export class ReportsComponent implements OnInit {
  ...
  columns: TableColumn[] = [
    { field: 'srNo', header: 'SR. NO.', width: '4.5rem', align: 'center', headerAlign: 'center', sortable: false },
    { field: 'name', header: 'REPORTS', align: 'left', headerAlign: 'left', sortable: false },
    { field: 'action', header: 'ACTION', width: '6rem', align: 'center', headerAlign: 'center', sortable: false }
  ];
  ...
  reports: ReportItem[] = [
    ...
    { srNo: 24, name: 'Audit Status Report', route: '/reports/audit-status-report', category: '2_audit' },
    { srNo: 25, name: 'Audit Status Expired Report', route: '/reports/audit-status-expired-report', category: '2_audit' },
    { srNo: 26, name: 'Executive Summary Audit Report', route: '/reports/executive-summary-audit-report', category: '2_audit' },
    { srNo: 27, name: 'Executive Summary Compliance Report', route: '/reports/executive-summary-compliance-report', category: '2_audit' },
    { srNo: 28, name: 'Assesment Timeline Report', route: '/reports/assesment-timeline-report', category: '2_audit' },
    { srNo: 29, name: 'Assement Not Started Yet Report', route: '/reports/assement-not-started-yet-report', category: '2_audit' },
    { srNo: 30, name: 'Audit Complete Report', route: '/reports/audit-complete-report', category: '2_audit' },
    { srNo: 31, name: 'Compliance Report', route: '/reports/compliance-report', category: '2_audit' },
    { srNo: 32, name: 'Compliance Summary Report', route: '/reports/compliance-summary-report', category: '2_audit' },
    { srNo: 33, name: 'Audit Observations Report', route: '/reports/audit-observations-report', category: '2_audit' },

    // Advanced Reports (category: '3_advanced')
    { srNo: 34, name: 'Risk Weightage Report', route: '/reports/risk-weightage-report', category: '3_advanced' },
    { srNo: 35, name: 'Broader Areawise Scoring Report', route: '/reports/broader-areawise-scoring-report', category: '3_advanced' },
    { srNo: 36, name: 'Risk Wise Audit Units Report', route: '/reports/risk-wise-audit-units-report', category: '3_advanced' },
    { srNo: 37, name: 'Audit Observation Count Report', route: '/reports/audit-observation-count-report', category: '3_advanced' },
    { srNo: 38, name: 'Pending Compliance Detailed Report', route: '/reports/pending-compliance-detail-report', category: '3_advanced' },
    { srNo: 39, name: 'Audit Committee Board Report - 1', route: '/reports/audit-committee-board-report-1', category: '3_advanced' },
    { srNo: 40, name: 'Question Wise BroaderArea Report', route: '/reports/questionwsie-broader-areawise-report', category: '3_advanced' },
    { srNo: 41, name: 'Internal Audit & Compliance Report', route: '/reports/internal-assesment-report', category: '3_advanced' },
    { srNo: 42, name: 'Performance Risk Weightage Report', route: '/reports/performance-risk-weightage-report', category: '3_advanced' },
    { srNo: 43, name: 'Performance Risk Weightage Report (Category Wise)', route: '/reports/performance-risk-weightage-report-category-wise', category: '3_advanced' },
    { srNo: 44, name: 'RBIA - Performance Risk Weightage Report (All Units)', route: '/reports/rbia-performance-risk-weightage-report-all-units', category: '3_advanced' }
  ];
