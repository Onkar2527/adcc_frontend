...
import { AdvanceAccountFormComponent } from './advance-accounts-form.component';
import { AdvanceUploadComponent } from './advance-upload.component';


import { ManageAccountsDataService, AuditUnitService, AuditSchemeMasterService } from '../../services/masters.service';
import { AdvanceUploadDumpsComponent } from './advance-upload-dumps.component';
...
export class AdvanceAccountsComponent
    ...
    async openUploadDumps() {
        ...
        await this.drawer.open(
            AdvanceUploadDumpsComponent,
            {

                header:
                    'Advance Upload Dumps',
    ...
    async openUploadDrawer() {
        ...
        await this.drawer.open(
            AdvanceUploadComponent,
            {

                header:
                    'Upload Advance Accounts',
    ...
    async openForm(row?: any) {
        ...
        const res = await this.drawer.open(
            AdvanceAccountFormComponent,
            {

                header: row
                    ? 'Edit Advance Account'
                    : 'Add Advance Account',
    ...
    remove(row: any) {
        ...
        this.confirmationService.confirm({
            ...
            message:
                'Are you sure you want to delete this advance account?',
